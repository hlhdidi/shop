...
function serachKeyword(){
	window.location.href = "/portal/product/list?keyword="+$("#keyword").val();
}
function toCart() {
	location.href="${pageContext.request.contextPath}/portal/cart/toCart?isLogin="+$("#isLogin").val()+"&username="+$("#username").val();
}
</script>
<!--shortcut start-->
		...
		<div id="settleup-2013">
			<dl>
				<dt class="ld">
					...
					<a href="#" onclick="toCart()" id="settleup-url">去购物车结算</a>
				</dt>
<!-- 				<dd>
					<div class="prompt">
