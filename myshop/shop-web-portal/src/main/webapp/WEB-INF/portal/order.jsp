...
<body id="mainframe">
	...
	<!-- main -->
<form action="/portal/order/submitOrder" method="post">
		...
		<div id="content" class="w">
							...
							<div id="payShipAndSkuInfo">
								...
								<div class="step-cont" id="skuPayAndShipment-cont">
									...
									<div class="shopping-lists" id="shopping-lists">
										<!--定义大商品清单LIST-->
										<c:forEach items="${buyerCart.items }" var="i">
												...
												<div class="goods-items">
													<div class="goods-suit goods-last">
														...
														<div class="goods-item goods-item-extra"
															goods-id="1305606">
															<input type="hidden" name="skuIds" value="${i.sku.id }"/>
															<div class="p-img">
																<a target="_blank"
																	href="http://item.jd.com/1305606.html"><img
																	src="${i.sku.product.images[0]}" alt=""></a>
															</div>
															<div class="goods-msg">
																<div class="goods-msg-gel">
																	<div class="p-name">
																		<a href="http://item.jd.com/1305606.html"
																			target="_blank">${i.sku.product.name } </a>
																	</div>
																	<div class="p-price">
																		<!--增加预售金额显示 begin   预售分阶段支付类型（1：一阶梯全款支付；2：一阶梯定金支付(全款或定金可选)；3：三阶梯(仅定金)；4：三阶梯(全款或定金可选)） -->
																		<strong class="jd-price">￥${i.sku.price }</strong>
																		<!--增加预售金额显示 end-->
																		<span class="p-num"> x${i.amount }</span> <span class="p-state"
			...
			<div class="order-summary">
				...
				<div class="statistic fr">
					<div class="list">
						<span><em class="ftx-01">${buyerCart.productAmount }</em> 件商品，总商品金额：</span> <em
							class="price" id="warePriceId" v="343.8">￥${buyerCart.productPrice }</em>
					</div>
					<div class="list">
					...
					<div class="list">
						<span><i class="freight-icon"></i>运费：</span> <em class="price"
							id="freightPriceId"><font color="#FF6600"> ￥${buyerCart.fee }</font></em>
					</div>
					...
					<div class="list">
						<span>应付总额：</span> <em class="price" id="sumPayPriceId">￥${buyerCart.totalPrice }</em>
					</div>
				</div>
				<div class="clr"></div>
			</div>
						...
						<div class="sticky-wrap">
							<div class="inner">
								<input type="submit" class="checkout-submit" value="提交订单" /> <span
									class="total">应付总额：<strong id="payPrice">￥${buyerCart.totalPrice }</strong>
							</div>
						</div>
					</div>
				</div>
