...
<script>
	function uploadPic() {
		var options={
			url:"${pageContext.request.contextPath}/console/brand/upload",
			type:"POST",
			dataType:"json",
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="${pageContext.request.contextPath }/console/brand/edit" method="post">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" ${brand.isDisplay==1?"checked":"" }/>可用
						<input type="radio" name="isDisplay" value="0" ${brand.isDisplay==0?"checked":"" }/>不可用
					</td>
				</tr>
			</tbody>
			<tbody>
