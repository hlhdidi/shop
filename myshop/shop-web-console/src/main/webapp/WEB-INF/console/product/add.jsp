			...
			if(ref == '#tab_3'){
				// 编辑器参数
		 		var kingEditorParams = {
					...
					//指定上传文件请求的url。
					uploadJson : '/console/product/uploadFck',
...
function uploadPic(){
	...
	var options = {
			url : "/console/product/uploadPics",
			type : "post",
			dataType : "json",
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="${pageContext.request.contextPath }/console/product/add" method="post" enctype="multipart/form-data">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						颜色:</td><td width="80%" class="pn-fcontent">
							...
							<input type="checkbox" value="${c.id }" name="colors"/>${c.name }
							</c:forEach>
					</td>
				</tr>
				<tr>
