...
<%@ include file="../date.jsp" %>
     <ul class="w-lful">
		...
		<li><a href="${pageContext.request.contextPath }/console/brand/list" target="rightFrame">品牌管理</a></li>
		<li><a href="${pageContext.request.contextPath }/console/product/productList" target="rightFrame">商品分类</a></li>
